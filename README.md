...
- Streamlining of identifiaction to, local models only, with exception of, huggingface and and adapt openai to LM Studio. If all LM Studio issues are fixed, then will be able to run Llama 3.1 70B in Q6 on 64GB System, with help from GPU memory. 
