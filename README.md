...
## DEVELOPMENT:
With the primary project of the batches done, there are some ideas...
- Due to repeating errors in using the program, development is stopped. I will try other models, but, if no better, then will wait for 0.55.0 at least. I assume the problem is between LiteLLM and Ollama. This is just trying to make my simple maze game with 4 files specified (see EXAMPLES section)...
```
