...
### DEVELOPMENT:
1. Complete download of model - Guessing [Meta-Llama-3.1-Chat-Uncensored-GGUF](https://huggingface.co/mradermacher/Meta-Llama-3.1-Chat-Uncensored-GGUF) in Q5 is the best one for 64GB System Ram. The meta ones improve performance by rounding off its abilities, and uncensored supposedly more intelligent.
2. Python version compatibility - waiting for model to make modelcard and test launching. Pip seems to work correctly, so I assume the python command in the launcher will. Relevant Upgrade Was... 
